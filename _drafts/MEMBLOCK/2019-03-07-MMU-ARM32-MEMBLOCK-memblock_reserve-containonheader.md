---
layout: post
title:  "memblock_reserve() Reserved 插入一块头部重合但终止地址小于原始的内存区块"
date:   2019-03-07 11:22:30 +0800
categories: [MMU]
excerpt: memblock_reserve() Reserved 插入一块头部重合但终止地址小于原始的内存区块.
tags:
  - MMU
---
...
验证当将一块与已存在的内存区块重合并且起始地址相同，但终止地址小于已存在内存区块的内存
