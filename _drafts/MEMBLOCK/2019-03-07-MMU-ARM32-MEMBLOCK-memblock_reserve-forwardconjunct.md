---
layout: post
title:  "memblock_reserve() Reserved 插入一块前段相连的内存区块"
date:   2019-03-07 15:33:30 +0800
categories: [MMU]
excerpt: memblock_reserve() Reserved 插入一块前段相连的内存区块.
tags:
  - MMU
---
...
加入一块新的内存区块，其终止地址与已存在的内存区块的起始地址重合。MEMBLOCK 是否会将这
两块内存区块合并为一块呢？
